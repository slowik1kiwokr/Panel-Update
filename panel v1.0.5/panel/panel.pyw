...
class BotManagerApp(ctk.CTk):
    ...
    def _build_sidebar(self):
        ...
        self.btn_github_update = ctk.CTkButton(menu, text="🔄 GitHub Frissítés", fg_color="#3498db", hover_color="#5dade2", command=self.update_from_github, height=34)
    ...
    def update_from_github(self):
        try:
            ...
            url = "https://github.com/SAJAT_REPO/archive/refs/heads/main.zip"  # <-- IDE A ZIP LINKED

            temp_zip = os.path.join(os.getcwd(), "update.zip")
            ...
            print("GitHub frissítés sikeres!")
        except Exception as e:
            print("GitHub frissítés hiba:", e)
